// === 구구단 출력기 ===
// : 사용자로부터 정수값을 입력받으면 해당 값이 구구단을 출력

// : while문 조건식에 true에 대한 boolean 값 적용 시 무한 루프
...
while(true) {
  ...
  const input = prompt('출력할 구구단의 숫자를 입력하세요 (2 ~ 9) // "exit 입력시 종료"')

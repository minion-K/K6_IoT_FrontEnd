...
// 3) find(), findIndex(): 특정 조건을 만족하는 첫 번째 요소/첫 번째 요소의 인덱스
//    >> 존재하지 않으면 -1 반환

let nums = [5, 4, 6, 1, 7, 3];

let firstOverthree = nums.find(num => num > 3);
console.log(firstOverthree); // 5 >> 3보다 큰 수는 4, 5, 6, 7 이지만 요소의 첫 번째 순서인 5가 출력

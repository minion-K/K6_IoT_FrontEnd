...
// ! === 이벤트 객체 ===
// : 이벤트 핸들러가 호출될 때, 브라우저가 자동으로
//    , '이벤트 객체'를 생성하여 이벤트 핸들러에게 전달
// - 이벤트와 관련된 다양한 속성과 메서드가 포함

// ! === 이벤트 속성과 메서드 ===

// ? 1. type
// : 이벤트 유형을 명시 (EX: 'click', 'change' 등)
...
form.onsubmit = (e) => {
  ...
  if(fname.value === '' || femail.value === '') {
    ...
    p.textContent = '이름과 이메일은 모두 필수 입력값 입니다.'
    p.style.color = 'red';
  }
}

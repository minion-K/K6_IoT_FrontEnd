...
greet1('홍길동', 32); // 안녕하세요, 홍길동님! 32세 입니다.
...
greet2(32, '홍길동'); // 안녕하세요, 홍길동님! 32세 입니다.
greet2(32); // 안녕하세요, 비회원 고객님! 32세 입니다.
...
function findMin(...numbers) {
  ...
  // 배열의 요소를 개별 인수로 펼치는 역할 (...연산자 - spread 연산자)

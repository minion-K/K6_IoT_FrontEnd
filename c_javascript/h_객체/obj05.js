...
// JSON 문자열의 키값은 반드시 "" 따옴표 사용 '필수'

let book2 = JSON.parse(jsonString);
console.log(book2); // { title: '백설공주', author: '홍길동', publishYear: 2025 }

book2.title = '신데렐라';
book2.author = '김철수';

console.log(book1); // { title: '백설공주', author: '홍길동', publishYear: 2025 }
console.log(book2); // { title: '신데렐라', author: '김철수', publishYear: 2025 }

...
// - 중괄호를 사용하여 객체를 선언, 초기화 (내부에 속성과 메서드 정의)
// - 같은 형태의 객체를 만들 때 중복 증가! 
...
// 변수종류 변수명 = new 생성자함수(파라미터 전달)
let person1 = new Human('홍길동', 32);
let person2 = new Human('김철수', 29);

...
/*
  ...
  4. TypeScript 설정 파일 (tsconfig.json) 생성 설정
  5. 기본 소스 구조 구성 (src 등)
  6. 빌드 & 실행 테스트
...
// % 3. typescript 설치
// : 타입스크립트 설치 (npm 사용)
// > 타입스크립트 사용을 위해서는 클립 | 전역 환경에 TS 설치가 필수

// ? npm을 사용하여 '타입스크립트 패키지' 설치
// - 전역 설치('g' 옵션, global)
// : 개발자 컴퓨터 전체에 기능 추가
// >> npm install -g typescriptnpm
...
//            (타입스크립트 전역 설치 완료 시 tsc --init만 입력해도 가능)

// {
//   "compilerOptions": {                         //? 변환될 JS 버전
//     "target": "ES2020",                        //? Node.js는 CommonJS모듈 사용
//     "module": "CommonJS",                      //? TypeScript 원본 코드 폴더
//     "rootDir": "./src",                        //? 컴파일된 JS 출력 폴더
//     "outDir": "./dist",                        //? 타입 검사 강화
//     "strict": true,                            //? import express from "express" 형태 사용
//     "esModuleInterop": true,                   //? 라이브러리 타입 검사 생략으로 속도 향상
//     "skipLibCheck": true,                     

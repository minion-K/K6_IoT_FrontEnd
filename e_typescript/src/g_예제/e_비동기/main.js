...
var currentPage = 1; // 현재 페이지 번호 추적 (기본값: 1 - 첫페이지)
var photoPerPage = 4; // 한 페이지당 표시할 이미지 개수
...
function renderPhotos(photos) {
    ...
    photos.forEach(function (photo) {
        var photoElment = document.createElement('div');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (pageNumber) {
                        pageNumber.textContent = "".concat(currentPage);
                    }
                    return [2 /*return*/];
            }
        });

...
// 1) min: 허용되는 최소값 (예: 1rem, 1px)
// 2) preferred: 브라우저가 먼저 계산하려고 하는 값(보통 vw 또는 clac() 사용)
// 3) max: 허용되는 최대값 (예: 2rem, 32px)
// >> 브라우저는 preffered 값을 계산한 뒤
//  , 그 값이 min보다 작으면 min / max보다 크면 max를 사용
  ...
  */
  return (
    ...
    >
      <h1
        style={{
          // 1.125rem(18px) 최소, 2.5vw 선호, 2rem(32px) 최대

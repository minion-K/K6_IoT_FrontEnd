    ...
    <ChartBox>
      ...
      */}
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          {/* CartesianGrid: 차트 배경에 격자선 */}
          {/* 속성: strokeDasharray: 점선을 3px그려짐 + 3px 비워짐 */}
          <CartesianGrid 
            strokeDasharray={"3 3"}
            strokeOpacity={0.06}  
          />
          {/* X축: 어떤 데이터 집합을 구성할 지 나열 */}
          ...
          {/* 
            type: 곡선 형태 설정
            > monotone-일반곡선, linear-직선, step-계단형, basis-더 부드러운 곡선)
          ...
          */}
          {/* 
            Y축: 데이터, Line이 어떤 필드를 그릴 지 결정하고 + Y축 기준 데이터를 받아  
            YAxis는 자동 스케일만 계산
          */}
          <Line 
            type='monotone'

// ! OpenWeatherAPI
// : 실시간 날씨 정보를 제공해주는 API(부분 무료)
// https://openweathermap.org/

const apiKey = '79aa92c51aaa5884bd61ce5c7a6a4c61';
const lang = 'kr';
...
document.getElementById("search-button").addEventListener('click', () => {
  ...
  // : input 창의 value 값을 getWeatherData에 전달
...
async function getWeatherData(city) {
  // !사용자로부터 입력한 도시 이름을 매개변수로 받아
  // !Open API에 요청하고 결과값을 displayWeather 함수에 문자로 전달하는 함수

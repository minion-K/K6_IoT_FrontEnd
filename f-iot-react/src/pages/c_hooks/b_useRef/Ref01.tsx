...
function Ref01() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    //& 11) 화면이 아니라 '개발자 도구 콘솔창'에 출력 - React가 렌더링하기 전에 JS 코드가 실행
  ...
  return (
    <div>
      ...
      {/* 
        ...
        >> 실제로 화면이 렌더링될 때는 이미 새로운 값(0)으로 초기화 된 상태
      */}
      {/* //& 16) 값의 유지 X: 0 출력 */}
      <p>컴포넌트가 렌더링될 때마다 초기화되는 값: {lengthVar}</p>
    </div>
  )
}

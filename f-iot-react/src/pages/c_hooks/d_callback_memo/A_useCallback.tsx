...
function A_useCallback() {
  ...
  /*
    ...
    ? 배열 안의 deps가 바뀔 때만 함수를 다시 생성
      : 그렇지 않으면 이전에 만든 함수를 재사용 (Memoization)
  */
  
  //& Event Handler ===
  // : 부모 컴포넌트 리렌더링 마다 함수의 주소값이 변경
  ...
  let a = 10; // 컴포넌트 재렌더링마다 새롭게 초기화되고 할당
  ...
  return (
    <div>
      ...
      {/* 
        1) props 값 변경으로 리렌더링 - useCallback으로 조절
        2) 실제 부모 컴포넌트의 리렌더링 - useCallback 조절 X
      */}

...
function Effect02() {
  ...
  return (
    <div style={{margin: '0 auto', padding: '20px', backgroundColor: 'lightblue'}}>
      <h4>Posts 게시물</h4>
      <input type="text" placeholder='검색어를 입력해주세요' onChange={(e) => setSearchTerm(e.target.value)}/>

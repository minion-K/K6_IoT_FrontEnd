...
//    EX) /api/v1/users   
//    EX) /api/v1/users/1   
//    EX) /api/v1/users/1/review/10

//    EX) /api/v1/users/me
//    EX) /api/v1/users/me/review
//    EX) /api/v1/users/me/review/10
...
//    : 일부 오래된 시스템 또는 프레임워크는 PATCH를 지원하지 않음 - PUT으로 통일하여 사용
